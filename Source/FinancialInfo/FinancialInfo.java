...
public class FinancialInfo {
    ...
    public LinkedList<FinancialRecord> newlist = new LinkedList<>();
    public HashMap<String, LinkedList<FinancialRecord>> expensesByCategory = new HashMap<>();
    ...
    public void Dashboard() {
        ...
        for (String entry : dataLinkedList) {
